...
The [Bermuda Institute of Ocean Science](https://bios.asu.edu/), known by those in a hurry as BIOS, is a marine science research institute with a long history of oceanography and marine biology. Home to one of the longest-running time series of biogeochemical measurements, BIOS questions how climate change will affect the world’s oceans and marine ecosystems.
...
<figure style="width: 100%" class="align-center">
  ...
  <figcaption>
  <strong> Scientific diving on the reef (and slightly less scientific floating).</strong> 
  </figcaption>
</figure>
