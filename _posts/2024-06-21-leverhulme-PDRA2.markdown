...
The geochemical measurements made by this PDRA will be interesting in their own right, and produce fundamental insights into the controls on biomineral geochemistry. Within the scope of the larger project, these data will be considered alongside measurements of the physiology and transcriptome of the same organisms (2 PDRAs + 1 PhD student). These combined physiogical and geochemical data will then be used to inform computational modelling of biomineralisation processes (1 PDRA + 1 PhD student). Together, these data will provide a comprehensive biological and geochemical dataset that will transform our understanding of biomineralisation.
